...
const LOCALES = {
  vi: {
    ...
    "notif.title": "Đến lúc đứng dậy! 🧍",
    "notif.message": "Bạn đã ngồi {n} phút rồi. Vươn vai một chút nhé!",
    tab_flash: "🔔 Đứng dậy!",
    "banner.text": "Đến lúc đứng dậy rồi!",
    "banner.done": "✓ Xong",
    "banner.snooze": "⏸ Hoãn",
  ...
  en: {
    ...
    "notif.title": "Time to stand! 🧍",
    "notif.message": "You've been sitting for {n} min. Quick stretch break!",
    tab_flash: "🔔 Stand up!",
    "banner.text": "Time to stand up!",
    "banner.done": "✓ Done",
    "banner.snooze": "⏸ Snooze",
