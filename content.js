/* ═══════════════════════════════════════════════
   ...
   ① Tab title flash
   ② Top banner bar with action buttons
   ═══════════════════════════════════════════════ */
...
function injectStyles() {
  ...
  style.textContent = `
    ...
    #${PP_BANNER_ID} .pp-dot {
      ...
      border-radius: 50%;
      background: #f59e0b;
      animation: pp-pulse-dot 1.2s ease-in-out infinite;
      flex-shrink: 0;
    }
    #${PP_BANNER_ID} .pp-icon {
      flex-shrink: 0;
    }
    ...
    #${PP_BANNER_ID} .pp-btn:hover {
      transform: translateY(-1px);
      filter: brightness(1.08);
    }
    #${PP_BANNER_ID} .pp-btn:active {
    ...
    #${PP_BANNER_ID} .pp-btn-snooze:hover {
...
function startTitleFlash() {
  ...
  _titleFlashTimer = setInterval(() => {
    document.title = toggle ? _originalTitle : "🔔 Đứng dậy!";
    toggle = !toggle;
  }, 1500);
}
...
function showBanner() {
  ...
  banner.innerHTML = `
    ...
    <span class="pp-text">Đến lúc đứng dậy rồi!</span>
    <div class="pp-actions">
      <button class="pp-btn pp-btn-done" data-action="done">✓ Xong</button>
      <button class="pp-btn pp-btn-snooze" data-action="snooze">⏸ Hoãn</button>
    </div>
  `;
